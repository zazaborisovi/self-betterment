...
const UserPage = () => {
    ...
    const StatCard = ({ title, xp, rank, colorFrom, colorTo, shadowColor }) => (
        <div className={`relative group p-6 rounded-3xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-[0_0_20px_${shadowColor}] transition-all duration-300 overflow-hidden`}>
            <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl ${colorFrom} to-transparent rounded-bl-[4rem] opacity-20 pointer-events-none transition-colors duration-300`}></div>
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                    <h3 className="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2">{title}</h3>
                    <div className={`text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r ${colorFrom} ${colorTo}`}>
                        {rank}
                    </div>
                </div>
                <div className="mt-6 flex flex-col gap-2">
                    ...
                    <div className="w-full bg-slate-100 dark:bg-slate-900 rounded-full h-2 overflow-hidden shadow-inner">
                        <div className={`h-full bg-gradient-to-r ${colorFrom} ${colorTo} w-full opacity-60`}></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="min-h-screen w-full bg-slate-50 dark:bg-slate-900 py-12 px-4 transition-colors duration-300 font-sans">
            <div className="max-w-5xl mx-auto flex flex-col items-center">
                ...
                <div className="w-full mb-12 text-center space-y-4">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-red-500 dark:from-purple-400 dark:via-pink-400 dark:to-red-400 tracking-tight drop-shadow-sm">
                        Character Sheet
                    </h1>
                </div>
                ...
                <div className="w-full bg-white dark:bg-slate-800 rounded-3xl p-6 md:p-10 shadow-xl mb-12 border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
                    ...
                    {/* Avatar placeholder */}
                    <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 rounded-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-1 shadow-[0_0_30px_rgba(168,85,247,0.4)]">
                        <div className="w-full h-full rounded-full bg-slate-50 dark:bg-slate-900 flex items-center justify-center border-4 border-transparent">
                            <span className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-purple-500 to-pink-500">
                    ...
                    <div className="flex flex-col gap-2 text-center md:text-left z-10 w-full">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div className="flex flex-col items-center justify-center p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shrink-0 shadow-inner min-w-[120px]">
                                ...
                                <span className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-600 drop-shadow-sm">
                                    {profile.rank}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col md:flex-row items-center gap-6">
                            <div className="flex-grow w-full">
                                <div className="flex justify-between items-end mb-2">
                                    ...
                                    <span className="text-xl font-bold text-slate-700 dark:text-slate-200">{profile.xp}</span>
                                </div>
                            </div>
                                ...
                                <div className="shrink-0 w-full md:w-auto">
                                    {isFriend ? (
                                        ...
                                        <button 
                                            ...
                                            className="w-full md:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold shadow-lg shadow-purple-500/25 transition-all active:scale-95 flex items-center justify-center gap-2"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
